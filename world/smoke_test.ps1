...
try {
    ...
    Assert-HasPattern $bridgePath 'switch-path' 'Bridge switch-path route is missing'
    ...
    Assert-HasPattern $webAppPath 'switch-path' 'Web path switcher API client is missing'
    ...
    Assert-HasPattern $webIndexPath 'id="pathSwitcher"' 'Web path switcher markup is missing'
