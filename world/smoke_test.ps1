...
try {
    ...
    Assert-HasPattern $bridgePath 'CLIENT_VERSION = "1.0.0"' 'Bridge client version must be 1.0.0'
    ...
    Assert-HasPattern ([System.IO.Path]::Combine($worldRoot, "archipelago.json")) '"full_version": "1.0.0"' 'World full_version must be 1.0.0'
